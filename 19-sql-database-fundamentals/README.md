...
1. **Database Design**: Design schema for a business application
2. **Data Analysis with SQL**: Analyze dataset using SQL queries
3. **SQL + Python Integration**: Build data pipeline with SQL and Python
