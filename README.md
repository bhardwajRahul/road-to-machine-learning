...
| [Backend Engineer Roadmap](resources/backend_engineering_roadmap.md) | Learn backend from HTTP through production: auth, Postgres, caching, queues, security, and scaling |
...
| [Backend Engineer Roadmap](resources/backend_engineering_roadmap.md) | HTTP, REST, Postgres, caching, queues, security, scaling, and ops with free links and repo cross-refs |
